  ...
  return (
    <nav className={`text-white w-full z-20 top-0 left-0 fixed ${scrolling ? "bg-black" : "bg-transparent"} border-b`}>
      ...
      <div
          ...
          id="navbar-sticky"
        >
        <ul id="menu" className="flex flex-col md:bg-transparent bg-black p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0">
            <li>

            <Link
              href="/"
              className="link-hover block py-2 pl-3 pr-4 hover:bg-yellow-500 md:hover:bg-transparent md:hover:text-yellow-500 md:p-0 md:dark:hover:text-yellow-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
            >
              Home
            </Link>
          </li>
          <li>
            <Link
              href="/About"
              className="link-hover block py-2 pl-3 pr-4 hover:bg-yellow-500 md:hover:bg-transparent md:hover:text-yellow-500 md:p-0"
            >
              About
            </Link>
          </li>
